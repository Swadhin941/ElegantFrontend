...
const CoverPhoto = (props) => {
    ...
    const handleChange = (e) => {
        ...
        if (type.toLowerCase() === "jpeg" || type.toLowerCase() === "png" || type.toLowerCase() === 'jpg') {
            ...
            img.onload = () => {
                setCoverImgHeight(img.height);
                setCoverImgWidth(img.width);
            }
    ...
    return (
        <div className='container-fluid p-0'>
            <div className={`coverOptionIconDiv`} onClick={() => handleCoverPhotoOption()}>
                <span><i className={`bi bi-three-dots-vertical ${tempCoverImg && "text-white"}`}></i></span>
            </div>
            {
            ...
            }
            {
                ...
                </>  : props?.coverImg ? <div className='coverPhotoImgDiv' onClick={handleCoverPhoto}>
